...
function onderwijs2006() {
  ...
  $('#chart-title').html('<h4>Stemgedrag naar hoogst behaalde opleiding <div class="btn-group" role="group"><button onclick="onderwijs2006()" type="button" class="btn btn-sm btn-secondary active">2006</button><button onclick="onderwijs2010()" type="button" class="btn btn-sm btn-secondary">2010</button><button onclick="onderwijs2012()" type="button" class="btn btn-sm btn-secondary">2012</button></div></h4>');
